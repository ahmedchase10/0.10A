  ...
  <div class="p-8 space-y-8">
    ...
    <div class="flex items-center justify-between gap-4">
      <div>
        ...
        <p class="text-grey-600 mt-1">Upload reusable lesson assets shared across all classes</p>
      </div>
      <div class="flex items-center gap-3">
        <button
          @click="refreshPage"
          :disabled="pageRefreshing"
          class="flex items-center gap-2 px-5 py-3 rounded-lg font-medium border border-grey-300 text-grey-700 bg-white hover:bg-grey-50 hover:border-grey-400 transition disabled:opacity-60"
        >
...
async function refreshPage() {
  ...
  try {
    ...
    console.error('Failed to refresh lessons page:', err);
  } finally {
